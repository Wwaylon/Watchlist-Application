...
BEGIN_EVENT_TABLE(EditDialog, wxDialog)
    EVT_UPDATE_UI(wxID_OK, EditDialog::onUpdateOkButton)
END_EVENT_TABLE()
...
//name field text
    wxStaticText *nameLabel = new wxStaticText(this, wxID_ANY, "new\nname: ");
...
//genre field text
    wxStaticText *genreLabel = new wxStaticText(this, wxID_ANY, "new\ngenre: ");
...
//status field text
    wxStaticText *statusLabel = new wxStaticText(this, wxID_ANY, "new\nstatus: ");
...
bool EditDialog::TransferDataFromWindow()
{
    id = idbox->GetValue();
...
void EditDialog::onUpdateOkButton(wxUpdateUIEvent& event)
{
    event.Enable(false);
